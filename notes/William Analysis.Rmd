...
# load("D:/OneDrive/OneDrive - Simon Fraser University (1sfu)/Research/Postdoc/Exact_Asymptotics/notes/William-Analysis_cache/MC-bin-bin-mix.RData", verbose = TRUE)
```
...
<!-- I'm now trying to figure out what's causing an error which only occurs on knit. Trying to isolate it in the following code chunk: -->
